...
=======
      {/* Audio control - Moved to a non-interfering position */}
      <motion.div 
...
=======
        <motion.button
          onClick={toggleMusic}
          className="flex items-center p-2 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-all"
>>>>>>> 7ebb4e5 (Your message here)
...
=======
      ...
      {/* Social Media Links - Fixed on the side with improved visibility */}
>>>>>>> 7ebb4e5 (Your message here)
      <motion.div 
...
=======
      {/* Mobile Social Media Links - Repositioned to avoid overlapping with other UI elements */}
      <motion.div 
        className="fixed bottom-24 left-1/2 transform -translate-x-1/2 flex space-x-6 z-30 md:hidden"
>>>>>>> 7ebb4e5 (Your message here)
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 2 }}
...
=======
      {/* Content section - Improved spacing and responsiveness */}
      <div className="relative z-10 flex flex-col items-center justify-center px-4 w-full max-w-4xl mx-auto h-full">
...
=======
          ...
          {showTitle && (
            <motion.h2
              className="text-sm sm:text-lg md:text-xl lg:text-2xl font-medium mb-5 sm:mb-6 max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-xl text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-white to-yellow-300"
>>>>>>> 7ebb4e5 (Your message here)
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
...
=======
          ...
          {showTitle && (
            <motion.div
              className="mb-6 px-4 py-3 rounded-lg bg-white/10 backdrop-blur-sm max-w-xs sm:max-w-sm md:max-w-lg text-center"
>>>>>>> 7ebb4e5 (Your message here)
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
...
=======
          {/* Register and Share buttons with better spacing */}
          {showTitle && (
            <motion.div
...
=======
                className="px-5 py-3 bg-gradient-to-r from-yellow-400 to-blue-500 text-white font-bold rounded-lg hover:from-yellow-500 hover:to-blue-600 transition-all flex items-center justify-center text-base w-full sm:w-auto"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                <Download className="mr-2 w-5 h-5" /> Register Now
>>>>>>> 7ebb4e5 (Your message here)
              </motion.a>
...
=======
                className="px-5 py-3 bg-white/10 backdrop-blur-sm text-white font-bold rounded-lg hover:bg-white/20 transition-all flex items-center justify-center text-base w-full sm:w-auto"
>>>>>>> 7ebb4e5 (Your message here)
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
...
=======
                <Share2 className="mr-2 w-5 h-5" /> Share Event
>>>>>>> 7ebb4e5 (Your message here)
              </motion.button>
            </motion.div>
          )}
...
=======
          {/* Event details cards with improved layout */}
          {showTitle && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8 w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl mx-auto">
              {/* Date card */}
              <motion.div
                className="flex items-center p-4 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 text-blue-400 hover:bg-white/20 transition-all duration-300"
>>>>>>> 7ebb4e5 (Your message here)
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
...
=======
                <Calendar className="mr-3 w-5 h-5 flex-shrink-0" />
                <div>
                  <h3 className="font-bold text-sm">Event Date</h3>
                  <p className="text-sm text-white/80 mt-1">{eventDetails.date}</p>
>>>>>>> 7ebb4e5 (Your message here)
                </div>
              </motion.div>
...
=======
                className="flex items-center p-4 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 text-green-500 hover:bg-white/20 transition-all duration-300"
>>>>>>> 7ebb4e5 (Your message here)
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
...
=======
                <MapPin className="mr-3 w-5 h-5 flex-shrink-0" />
                <div className="flex-1 overflow-hidden">
                  <h3 className="font-bold text-sm">Venue</h3>
                  <p className="text-sm text-white/80 mt-1 truncate">{eventDetails.venue}</p>
>>>>>>> 7ebb4e5 (Your message here)
                </div>
              </motion.a>
            </div>
...
=======
      ...
      {showScrollIndicator && showTitle && (
        ...
        >
          <p className="text-white text-sm mb-2 opacity-70">Scroll to discover events</p>
