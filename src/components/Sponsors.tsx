  ...
  const sponsors = [
    {
      ...
      color: "#d4af37",
      objectFit: "contain" // Adding specific fit for Chennai Computers
    },
    {
      ...
      color: "#c0a86e",
      objectFit: "cover" // Keep default for other images
    },
  ];
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="grid md:grid-cols-2 min-h-[400px]">
                      {/* Image Side - Modified to handle different objectFit values */}
                      <div className="relative h-64 md:h-full overflow-hidden bg-black/80">
                        <motion.img
                          ...
                          className={`absolute inset-0 w-full h-full ${
                            sponsors[activeIndex].name === "Chennai Computers" 
                              ? "object-contain p-4" 
                              : "object-cover"
                          }`}
                        />
