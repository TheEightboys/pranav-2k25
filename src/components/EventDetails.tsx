            ...
            {activeTab === "about" && (
              <div className="font-serif">
                ...
                <div className="mt-4 p-3 bg-amber-900/20 rounded-lg">
                  ...
                  {event.timing && (
                    <>
                      <p className="font-semibold text-amber-300 mt-3">Timing:</p>
                      <p>{event.timing}</p>
                    </>
                  )}
                  ...
                  {event.price && (
                    <>
                      <p className="font-semibold text-amber-300 mt-3">Entry Fee:</p>
                      <p>{event.price}</p>
                    </>
                  )}
                </div>
                      ...
                      <div className="flex flex-col mt-2 space-y-2">
                        ...
                        {coordinator.email && (
                          <a 
                            ...
                            className="flex items-center text-amber-200 hover:text-amber-100"
                          >
                            <Mail className="w-4 h-4 mr-2" /> {coordinator.email}
                          </a>
                        )}
                      </div>
                    </div>
